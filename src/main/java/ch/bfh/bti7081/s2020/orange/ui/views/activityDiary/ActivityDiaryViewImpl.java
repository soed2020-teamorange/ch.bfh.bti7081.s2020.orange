...
public class ActivityDiaryViewImpl extends VerticalLayout implements ActivityDiaryView,
    HasLogger {
  ...
  @PostConstruct
  public void init() {
    add(new H1(AppConst.TITLE_ACTIVITYDIARY),
        buildForm());
  }
  ...
  private Div buildForm() {
    ...
    ComboBox<String> activityCB = new ComboBox<>("Stimmung");
    ...
    binder.forField(contentTA)
            ...
            .bind(ActivityEntry::getDescription, ActivityEntry::setDescription);
    ...
    FormLayout formLayout = new FormLayout(dateDP, timeStartTP, timeEndTP, activityCB, contentTA, saveButton);
